  ...
  async fetch(t, n) {
    try {
      ...
      _ ||
        ((L = (await T(n)) || {}),
          k(
            `[fetch]--\x3e kv_id = ${L.kv_id}, kv_pDomain = ${
              JSON.stringify(L.pDomain)
            }, kv_p64Domain = ${JSON.stringify(L.kv_p64Domain)}`,
          ));
                  ...
                  new WritableStream({
                    async write(t) {
                      ...
                      const {
                        ...
                        addressRemote: c = "",
                        rawDataIndex: h,
                        channelVersion: p = new Uint8Array([0, 0]),
                        isUDP: y,
                        addressType: w,
                      } = (function (t, e) {
                        if (t.byteLength < 24) {
                        ...
                        if (1 === c) a = !1;
                          ...
                          if (2 !== c) {
                            return {
                              hasError: !0,
                              message:
                                `command ${c} is not support, command 01-tcp,02-udp,03-mux`,
                            };
                          }
                          a = !0;
                        }
                        ...
                        if (!w) {
                          return {
                            hasError: !0,
                            message:
                              `addressValue is empty, addressType is ${f}`,
                          };
                        }
                        return {
                          hasError: !1,
                      ...
                      if (
                        ((s = c),
                          (i = `${n} ${y ? "udp" : "tcp"} `),
                          o(
                            `handleRequestHeader--\x3e${w} Processing TCP outbound connection ${c}:${n}`,
                          ),
                          r)
                      ) {
...
!(function () {
  ...
  var n = !e && "object" == typeof self,
    a = !r.JS_SHA256_NO_NODE_JS &&
      "object" == typeof process &&
      process.versions &&
      process.versions.node;
  a ? (r = global) : n && (r = self);
  var s = !r.JS_SHA256_NO_COMMON_JS && "object" == typeof module &&
      module.exports,
  ...
  var p = function (t, e) {
    ...
    w = function (e, n) {
      var a,
        ...
        o = n ? "sha224" : "sha256";
      a = i.from && !r.JS_SHA256_NO_BUFFER_FROM ? i.from : function (t) {
        return new i(t);
      };
      return function (r) {
        if ("string" == typeof r) {
  ...
  ((g.prototype.update = function (e) {
    ...
    (g.prototype.digest = function () {
      ...
      return (
        this.is224 ||
        c.push((o >>> 24) & 255, (o >>> 16) & 255, (o >>> 8) & 255, 255 & o), c
      );
    }),
